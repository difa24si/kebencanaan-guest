    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('kejadian.update', $kejadian->kejadian_id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="dampak" class="form-control" value="{{ old('dampak', $kejadian->dampak) }}">
                @error('dampak')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="status_kejadian" class="form-control">
                    ...
                    <option value="Selesai" {{ $kejadian->status_kejadian == 'Selesai' ? 'selected' : '' }}>Selesai
                    </option>
                </select>
            ...
            <div class="mb-3">
                ...
                @if ($kejadian->media->count())
                    <div class="mt-2">
                        ...
                        <img src="{{ asset('storage/' . $kejadian->media->first()->file_name) }}" class="rounded"
